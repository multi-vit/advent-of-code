...
Variable to track highestTotal and currentTotal
Loop through array and if current element is a number, add it to currentTotal
When we reach a blank element, compare currentTotal to highestTotal and replace highestTotal with currentTotal if currentTotal is greater
This will leave us with the highestTotal as the correct answer
*/
const fs = require("fs");
...
for (let i = 0; i < splitArray.length; i++) {
  ...
  if (!isNaN(currentValue)) {
    ...
    if (currentTotal > highestTotal) {
      // console.log("New highest total: " + currentTotal);
...
console.log(`Final highest total is: ${highestTotal}`);
